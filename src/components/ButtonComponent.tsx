    ...
    <div>
      ...
      {showButtons && (
        <div className="h-20 w-20 fixed bottom-0 right-0 z-30 flex place-items-center duration-300 mx-20 my-56 flex flex-col">
            <a href="/edit">
            <button className="bg-inherit hover:bg-red-800 hover:border-red-800 hover:text-black text-white w-[100px] h-[50px] rounded-xl border-solid border-2 border-white font-normal text-xl underline-offset-0 my-2">
                update
            </button>
            </a>
            <a href="/delete">
